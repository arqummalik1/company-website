...
export default function Testimonials({ cards }: TestimonialsProps) {
  ...
  const getCardClassName = (index: number, baseClassName: string, totalCards: number) => {
    const focusedIndex = hoveredIndex ?? activeIndex;
    
    if (!focusedIndex) return baseClassName;
    ...
    if (totalCards === 5) {
      ...
      if (focusedIndex === 0 && index === 3) {
        return baseClassName + " !translate-y-32 sm:!translate-y-48 !translate-x-26 sm:!translate-x-40";
      }
      if (focusedIndex === 0 && index === 4) {
        return baseClassName + " !translate-y-40 sm:!translate-y-60 !translate-x-34 sm:!translate-x-52";
      }
      ...
      if (focusedIndex === 1 && index === 4) {
        return baseClassName + " !translate-y-32 sm:!translate-y-48 !translate-x-26 sm:!translate-x-40";
      }
      if (focusedIndex === 2 && index === 3) {
        return baseClassName + " !translate-y-16 sm:!translate-y-24 !translate-x-10 sm:!translate-x-16";
      }
      if (focusedIndex === 2 && index === 4) {
        return baseClassName + " !translate-y-24 sm:!translate-y-36 !translate-x-18 sm:!translate-x-28";
      }
      if (focusedIndex === 3 && index === 4) {
        return baseClassName + " !translate-y-16 sm:!translate-y-24 !translate-x-10 sm:!translate-x-16";
      }
    }

    // Handle 3 cards (original)
    if (focusedIndex === 0 && index === 1) {
  ...
  // 5 testimonials: 3 foreigners + 2 Indians with Unsplash images
  const defaultCards: TestimonialCardProps[] = [
    // Foreigner 1 - Sarah Chen (UK)
    {
      className:
      ...
      username: "Sarah Chen",
      handle: "@sarahchen_uk",
      content: "The team's expertise in building scalable solutions transformed our product. Exceptional work on the frontend architecture! 🚀",
      date: "Dec 28, 2025",
      verified: true,
      likes: 89,
      retweets: 12,
    ...
    // Foreigner 2 - Marcus Weber (Germany)
    {
      className:
        "[grid-area:stack] translate-x-6 sm:translate-x-12 translate-y-4 sm:translate-y-8 hover:-translate-y-1 before:absolute before:w-[100%] before:outline-1 before:rounded-2xl before:outline-border before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/60 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-500 hover:grayscale-0 before:left-0 before:top-0",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
      username: "Marcus Weber",
      handle: "@marcusw_dev",
      content: "Outstanding collaboration on our fintech platform. The attention to detail and clean code practices are remarkable!",
      date: "Dec 25, 2025",
      verified: true,
      likes: 67,
      retweets: 9,
    ...
    // Indian 1 - Priya Sharma (India)
    {
      className:
        "[grid-area:stack] translate-x-12 sm:translate-x-24 translate-y-8 sm:translate-y-16 hover:-translate-y-2 before:absolute before:w-[100%] before:outline-1 before:rounded-2xl before:outline-border before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/60 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-500 hover:grayscale-0 before:left-0 before:top-0",
      avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
      username: "Priya Sharma",
      handle: "@priyasharma_in",
      content: "Working with this team was incredible! They delivered our e-commerce platform ahead of schedule with flawless execution! ⭐",
      date: "Dec 22, 2025",
      verified: true,
      likes: 124,
      retweets: 18,
    ...
    // Foreigner 3 - James Wilson (USA)
    {
      className:
        "[grid-area:stack] translate-x-18 sm:translate-x-36 translate-y-12 sm:translate-y-24 hover:translate-y-4 sm:hover:translate-y-8",
      avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
      username: "James Wilson",
      handle: "@jameswilson_us",
      content: "Best development experience I've had in years. The team's understanding of modern web technologies is top-notch!",
      date: "Dec 20, 2025",
      verified: true,
      likes: 156,
      retweets: 24,
    ...
    // Indian 2 - Arjun Patel (India)
    {
      className:
        "[grid-area:stack] translate-x-24 sm:translate-x-48 translate-y-16 sm:translate-y-32 hover:translate-y-6 sm:hover:translate-y-12",
      avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop&crop=face",
      username: "Arjun Patel",
      handle: "@arjunpatel_in",
      content: "From concept to deployment, the experience was seamless. The React expertise and design sensibilities exceeded all expectations! 🇮🇳",
      date: "Dec 18, 2025",
      verified: true,
      likes: 203,
      retweets: 31,
    ...
    <div className="grid [grid-template-areas:'stack'] place-items-center opacity-100 animate-in fade-in-0 duration-700">
      {displayCards.map((cardProps, index) => (
        <TestimonialCard
          key={index}
          {...cardProps}
          className={getCardClassName(index, cardProps.className || "", totalCards)}
...
function Component({ cards }: TestimonialsProps) {
  return (
