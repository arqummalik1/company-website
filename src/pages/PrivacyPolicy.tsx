...
export default function PrivacyPolicy() {
    return (
        <PageWrapper
            title="Privacy Policy - Audentix"
            description="Privacy Policy for Audentix. Learn how we collect, use, and protect your data."
            keywords="privacy policy, data protection, gdpr, audentix privacy"
        >
                    ...
                    >
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8 text-[var(--text-secondary)]">
                            <section>
                                ...
                                <p>
                                    Welcome to Audentix ("Company", "we", "our", "us"). We respect your privacy and are committed to protecting your personal data.
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">5. Your Legal Rights</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">6. Contact Us</h2>
                                <p>
